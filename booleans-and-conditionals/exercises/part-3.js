...
if (fuelLevel > 20000 && engineTemperature <= 2500) {
    ...
    console.log("Fuel level is above 50%" + "." + "Engines are good" + ".");
 } else if ( fuelLevel > 5000 && engineTemperature <= 2500) {
    console.log("Fuel Level above 25%" + "." + "Engines are good" + ".");
 } else if ( fuelLevel > 5000 && engineTemperature <= 2500) {
    console.log("Fuel Level above 25%" + "." + "Engines are good" + ".");
 } else if (fuelLevel <= 5000 || engineTemperature > 2500) {
...
if (!commandOverride === true && fuelCheck === true && engineCheck ===true) {
    console.log("Shuttle launched successfully" + "!" + "Ignoring fuel and engine status" + ".");
} 
if (fuelCheck && engineCheck === true) {
    console.log("shuttle Has Launched" + "!");
} else if  (fuelCheck || engineCheck === false) {
console.log("Launch failed" +"." + "Fuel and Engine check failed" + "!");
} 
